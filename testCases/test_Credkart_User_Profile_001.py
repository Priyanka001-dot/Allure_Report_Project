...
class Test_User_Profile_Class :
    ...
    def test_verify_application_url_001(self):
        ...
        if self.driver.title == "CredKart":
            ...
            self.driver.save_screenshot(".\\Screenshots\\title_pass.png")
            allure.attach.file(".\\Screenshots\\title_pass.png", name="title_pass",
...
# pytest -v -s -n=5  --browser firefox --alluredir=Allure_Reports -k"test_verify_application_url_001"
...
# pytest
# Credkart Project
# Orange HRM Project using AI -pending - revision -- workshop online


# only API --> API -Hitesh sir 22-25 session
# only ETL and Both--> SQL --> Jayesh sir -- 2 months
